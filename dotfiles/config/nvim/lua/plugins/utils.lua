...
map("n", "<leader>g", function() fzf.live_grep() end, { desc = "Grep" })
map("n", "<leader>f", function() fzf.files() end, { desc = "Files" })
map("n", "<leader>.", function() fzf.resume() end, { desc = "Resume" })
map("n", "<leader>F", function() fzf.oldfiles() end, { desc = "Old Files" })
map("n", "<leader>b", function() fzf.buffers() end, { desc = "Buffers" })
map("n", "<leader>/", function() fzf.lines() end, { desc = "Lines" })
map("n", "<leader>?", function() fzf.builtin() end, { desc = "Pickers" })
map("n", "<leader>c", function() fzf.commands() end, { desc = "Commands" })
map("n", "<leader>*", function() fzf.grep_cword() end, { desc = "Word" })
...
map("n", "<leader>la", function() fzf.lsp_code_actions() end, { desc = "Diagnostics" })
